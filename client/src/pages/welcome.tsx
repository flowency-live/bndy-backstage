  ...
  return (
    <div className="min-h-screen bg-gradient-subtle p-4 flex flex-col items-center justify-center">
      <div className="text-center animate-fade-in">
        ...
        {/* Artist selection boxes - 2x2 grid with horizontal layout */}
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <div className="text-left min-w-0 flex-1">
                  <h3 className="text-sm font-sans font-semibold text-brand-primary leading-tight">{membership.artist?.name || membership.name}</h3>
                  <p className="text-xs text-gray-600 leading-tight">{membership.display_name} • {membership.role}</p>
                </div>
              </div>
            </div>
          ))}
